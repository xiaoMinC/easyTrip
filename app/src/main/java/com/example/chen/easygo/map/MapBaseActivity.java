...
import com.example.chen.easygo.map.util.ErrorInfo;
import com.example.chen.easygo.map.util.TTSController;
...
public abstract class MapBaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
...
//    protected NaviLatLng mStartLatlng = new NaviLatLng(39.825934,116.342972);
    ...
    public void setLatlng(NaviLatLng mStartLatlng,NaviLatLng mEndLatlng){
...
//        停止导航之后，会触及底层stop，然后就不会再有回调了，但是讯飞当前还是没有说完的半句话还是会说完
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (mAMapNaviView != null || mAMapNavi != null){
